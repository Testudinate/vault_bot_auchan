...
# ══════════════════════════════════════════════
BOT_TOKEN  = "y0__xCfjZ3CCBiWkRMg6N2shxXLF5aEUbc_MMt-E6joRY1nVGTYWw"        # ← токен бота из admin.yandex.ru
VAULT_PATH = "/Users/ods/Downloads/AI/ObsidianVault"        # ← путь к вашему Obsidian vault
SYNC_EVERY_HOURS = 1                  # ← как часто обновлять (в часах)
